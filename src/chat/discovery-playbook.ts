...
export function buildChatWorkflowDraftPrompt(options: ChatWorkflowDraftPromptOptions): string {
  ...
  return [
    ...
    "For merchant account create fields, use merchantId for the MID value and include name. Do not use mid or paymentBrand fields on create; they are not create_merchant_account API fields. For subtype routing such as VISA, use attach_merchant_account/subTypes where applicable or inspect describe_operation before choosing fields.",
