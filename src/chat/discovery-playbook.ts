...
export function buildChatWorkflowDraftPrompt(options: ChatWorkflowDraftPromptOptions): string {
  ...
  return [
    ...
    "Do not use mid, identification, paymentBrand, paymentBrands, brands, or config fields on merchant account create; they are not create_merchant_account API fields. For subtype routing such as VISA, use attach_merchant_account/subTypes where applicable or inspect describe_operation before choosing fields.",
