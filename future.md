...
- Namespace/synonym strategy finalization: explicitly “to be defined during implementation” in 2026-03-20_PRD_v1.md:446.
- Spec/data update channel: not present; current model is still release-based/manual update. - connect to Readme.io?
